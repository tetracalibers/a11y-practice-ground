<script lang="ts">
  import Link from "@/components/dropdown-nav-bar/link.svelte"
  import DropdownNavBar from "@/components/dropdown-nav-bar/dropdown-nav-bar.svelte"
  import HasPopup from "@/components/dropdown-nav-bar/has-popup.svelte"
</script>

<DropdownNavBar label="Mythical University">
  <Link href="#home">Home</Link>
  <HasPopup title="About">
    <Link href="#overview">Overview</Link>
    <Link href="#adminstration">Administration</Link>
    <HasPopup title="Facts">
      <Link href="#history">History</Link>
      <Link href="#current-statistics">Current Statistics</Link>
      <Link href="#awards">Awards</Link>
    </HasPopup>
    <HasPopup title="Campus Tours">
  ...
  <HasPopup title="Admissions">
    <Link href="#apply">Apply</Link>
    <HasPopup title="Tuition">
  ...
  <HasPopup title="Academic">
    ...
    <Link href="#tanscripts">Transcripts</Link>
  </HasPopup>
</DropdownNavBar>
